...
import copy
import argparse
from yolosa import YOLOSAWorld

parser = argparse.ArgumentParser(
    description="Host YOLOSA-World as a local web service."
)
parser.add_argument(
    "--yoloworld-ckpt",
    default="ckpts/yolov8l-sam-world.pt",
    type=str,
    help="The path to the PyTorch checkpoint of YOLO-World."
)
parser.add_argument(
    "--sam-ckpt",
    default="ckpts/sam_adapter_prompt_encoder_decoder.pt",
    type=str,
    help="The path to the SAM model of YOLOSA-World."
)
...
sam = sam_model_registry["vit_h"](checkpoint='ckpts/sam_vit_h_4b8939.pth').to(device=device)
yolosa = YOLOSAWorld(args.yoloworld_ckpt, sam_ckpt=args.sam_ckpt, decoder_ckpt='ckpts/custom_sam.pt').to(device=device)
sam.image_encoder = yolosa.sam.image_encoder
sam = sam.to(device=device)
sam.eval()
predictor = SamPredictor(sam)
# yolosa.eval()
# predictor = yolosa.sam_predictor


examples = [
    ["yolosa/web_demo/assets/1.jpeg"],
    ["yolosa/web_demo/assets/2.jpeg"],
    ["yolosa/web_demo/assets/3.jpeg"],
    ["yolosa/web_demo/assets/4.jpeg"],
    ["yolosa/web_demo/assets/5.jpeg"],
    ["yolosa/web_demo/assets/6.jpeg"],
    ["yolosa/web_demo/assets/7.jpeg"],
    ["yolosa/web_demo/assets/8.jpeg"],
    ["yolosa/web_demo/assets/9.jpeg"],
    ["yolosa/web_demo/assets/10.jpeg"],
    ["yolosa/web_demo/assets/11.jpeg"],
    ["yolosa/web_demo/assets/12.jpeg"],
    ["yolosa/web_demo/assets/13.jpeg"],
    ["yolosa/web_demo/assets/14.jpeg"],
    ["yolosa/web_demo/assets/15.jpeg"],
    ["yolosa/web_demo/assets/16.jpeg"]
]
